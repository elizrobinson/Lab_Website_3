...
app.get('/team_stats', function(req, res) {
  ...
  var num_winning_games = 'SELECT COUNT(*) as wins FROM football_games WHERE home_score > visitor_score;';
  var num_losing_games = 'SELECT COUNT(*) as losses FROM football_games WHERE home_score < visitor_score;'; 

  db.task('get-everything', task => {
        return task.batch([
            task.any(games),
            task.any(num_winning_games),
            task.any(num_losing_games)
        ]);
    })
    .then(info => {
